  ...
  def create
    ...
    respond_to do |format|
      if @voter.save
        ...
        @audit = Audit.create(affected_table: "Voter", latest_known_data: @voter, election_id: @voter.election_id, changed_by: current_user.email, operation_type: "created")
      else
  ...
  def update
    respond_to do |format|
      if @voter.update(voter_params)
        ...
        @audit = Audit.create(affected_table: "Voter", latest_known_data: @voter, election_id: @voter.election_id, changed_by: current_user.email, operation_type: "updated")
      else
